...
@onready var damage: GPUParticles2D = $Yellow/damage
@onready var sprite_2d: Sprite2D = $Yellow/Sprite2D
@onready var collision_shape_2d: CollisionShape2D = $Yellow/CollisionShape2D

static var sounds_playing: int = 0


func _ready():
	var body: RigidBody2D = $Yellow
