...
@onready var damage: GPUParticles2D = $Blue/damage
@onready var sprite_2d: Sprite2D = $Blue/Sprite2D
@onready var collision_shape_2d: CollisionShape2D = $Blue/CollisionShape2D
