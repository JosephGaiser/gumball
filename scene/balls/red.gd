...
@onready var damage: GPUParticles2D = $Red/damage
@onready var sprite_2d: Sprite2D = $Red/Sprite2D
@onready var collision_shape_2d: CollisionShape2D = $Red/CollisionShape2D

static var sounds_playing: int = 0


func _ready():
	var body: RigidBody2D = $Red
